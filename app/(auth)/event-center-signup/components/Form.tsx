    ...
    return (
        <>
            <form onSubmit={handleSubmit}>
                ...
                <Button type="submit" disabled={loading} className="mt-4 bg-[#095A66] hover:bg-[#095A66] text-base w-full py-6 lg:text-lg">{loading ? <Spinner className="mx-auto h-7 w-7 animate-spin" /> : 'Register'}</Button>
            </form>
