                    ...
                    <nav className="flex md:h-screen md:p-6 lg:w-[210px] md:w-[190px] md:mx-auto z-[10000] md:flex md:justify-center lg:relative fixed md:relative bottom-0 right-0 left-0 shadow-md bg-[#856D47] md:shadow-none justify-between py-4 z-100 active:z-100 m-6 px-6 md:m-0 md:px-0 rounded-lg md:rounded-none bg-white-1 ">
                        <nav className="my-10 z-[10000] md:block hidden">
                            ...
                            <nav className="absolute bottom-0">
                                <button
                                    onClick={logOutUser}
                                    className="px-4 cursor-pointer flex items-center space-x-2 bg-white py-2 rounded-lg mb-3"
                                >
                                    <span>
                                        <LogOutIcon className="h-5 w-8" />
                                    </span>
                                    <span>Logout</span>
                                </button>
                            </nav>
                        ...
                        <ul className="flex justify-between gap-4 z-[10000] w-full md:hidden">
                            <Link href={`/dashboard`}>
                                <li
                                    ...
                                    } space-x-2 py-2 px-3 items-center text-sm active:scale-100 cursor-pointer rounded-3xl`}
                                >
